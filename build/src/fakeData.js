...
exports.populateDB = () => __awaiter(this, void 0, void 0, function* () {
    ...
    const review1 = new Review_1.Review();
    const review2 = new Review_1.Review();
    review1.student1 = student2;
    review1.student2 = student3;
    ...
    yield typeorm_1.getConnection().manager.save(review1);
    yield typeorm_1.getConnection().manager.save(review2);
});
